...
Object.defineProperty(exports, "__esModule", { value: true });
const app_header_1 = __webpack_require__(/*! ./components/app-header */ "./src/scripts/components/app-header.ts");
const app_root_1 = __webpack_require__(/*! ./components/app-root */ "./src/scripts/components/app-root.ts");
const app_form_1 = __webpack_require__(/*! ./components/app-form */ "./src/scripts/components/app-form.ts");
const app_header_container_1 = __webpack_require__(/*! ./containers/app-header-container */ "./src/scripts/containers/app-header-container.ts");
const components = [
    app_root_1.default,
    app_header_1.default,
    app_form_1.default,
    app_header_container_1.default
];
components.forEach((component) => {
    const componentName = component.name.match(/[A-Z][a-z]+/g).join('-').toLowerCase();
...
/***/ "./src/scripts/components/app-form.ts":
/*!********************************************!*\
  !*** ./src/scripts/components/app-form.ts ***!
  \********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const custom_component_1 = __webpack_require__(/*! ../shared/components/custom-component */ "./src/scripts/shared/components/custom-component.ts");
...
`;
class AppForm extends custom_component_1.default {
    constructor() {
        super(tmplInnerHtml);
    }
    connectedCallback() {
        ...
        rxjs_1.fromEvent(this.titleForm, 'submit')
            .pipe(operators_1.tap((event) => event.preventDefault()), operators_1.filter(() => this.titleInput.value !== ''), operators_1.map(() => ({ title: this.titleInput.value, isMobile: this.isMobile.checked })), operators_1.takeUntil(this.onDestroy$))
...
/***/ "./src/scripts/components/app-header.ts":
/*!**********************************************!*\
  !*** ./src/scripts/components/app-header.ts ***!
  \**********************************************/
/*! no static exports found */
...
`;
class AppHeader extends custom_component_1.default {
    constructor() {
        super(tmplInnerHtml);
    }
    ...
    handleTitleColorChange(oldVal, newVal) {
    }
    changeTitle() {
...
/***/ "./src/scripts/components/app-root.ts":
/*!********************************************!*\
  !*** ./src/scripts/components/app-root.ts ***!
  \********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const store_1 = __webpack_require__(/*! ../store/store */ "./src/scripts/store/store.ts");
const custom_component_1 = __webpack_require__(/*! ../shared/components/custom-component */ "./src/scripts/shared/components/custom-component.ts");
const tmpl = `
    <app-header-container></app-header-container>
    <app-form></app-form>
`;
class AppRoot extends custom_component_1.default {
    constructor() {
        super(tmpl);
    }
    connectedCallback() {
    ...
    initApp() {
        this.appHeaderContainer = this.shadowRoot.querySelector('app-header-container');
        this.appForm = this.shadowRoot.querySelector('app-form');
...
/***/ "./src/scripts/containers/app-header-container.ts":
/*!********************************************************!*\
  !*** ./src/scripts/containers/app-header-container.ts ***!
  \********************************************************/
/*! no static exports found */
...
`;
class AppHeaderContainer extends custom_component_1.default {
    constructor() {
        super(tmplInnerHtml);
    }
    connectedCallback() {
...
__webpack_require__(/*! ./components-map */ "./src/scripts/components-map.ts");


/***/ }),

/***/ "./src/scripts/shared/components/custom-component.ts":
/*!***********************************************************!*\
  !*** ./src/scripts/shared/components/custom-component.ts ***!
  \***********************************************************/
/*! no static exports found */
...
class CustomComponent extends HTMLElement {
    constructor(tmplInnerHtml) {
        super();
        this.tmplInnerHtml = tmplInnerHtml;
...
class AppStore {
    constructor() {
        this.titleMsgSrc$ = new rxjs_1.BehaviorSubject('Default Title');
        this.title$ = this.titleMsgSrc$.asObservable().pipe(operators_1.distinctUntilChanged());
        this.isMobileMsgSrc$ = new rxjs_1.BehaviorSubject(false);
        this.isMobile$ = this.isMobileMsgSrc$.asObservable().pipe(operators_1.distinctUntilChanged());
    }
    set title(title) {
